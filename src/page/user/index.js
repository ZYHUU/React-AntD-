    ...
    return (
      <div>
        ...
        <Card style={{ marginTop: 10 }} className="operate-wrap">
          <Button icon="plus" onClick={() => this.handleOperate("create")}>
            创建员工
          </Button>
          <Button icon="edit" onClick={() => this.handleOperate("edit")}>
            编辑员工
          </Button>
          <Button onClick={() => this.handleOperate("detail")}>员工详情</Button>
          <Button icon="delete" onClick={() => this.handleOperate("delete")}>
            删除员工
          </Button>
        </Card>
